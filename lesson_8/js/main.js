...
function Car(model, prodCompany, year, maxSpeed, vEngine) {
    ...
    this.info = function () {
        return '-----more information-----'.toUpperCase();
    }
    ...
    this.increaseMaxSpeed = function (newSpeed) {
        ...
        if (speed < 0) {
            ...
            return this.maxSpeed = `${speed} km/h`;
        }
    }
    ...
    this.addDriver = function (name, age, exp) {
        if (name.length < 3) throw new Error('min name length');
        this.drivers.push(new Driver(name, age, exp));
        return carA.drivers[1];
    }
}
...
const carA = new Car('accord', 'honda', '2015', 280, 3500);
console.log(carA);
console.log(carA.drive());
console.log(carA.info());
console.log(carA.increaseMaxSpeed(80));
console.log(carA.changeYear(2017));
// console.log(carA.addDriver('Ivan', 33, 16));
// console.log(carA.addDriver('Viktor', 30, 5));
...
let autoB = new Auto('A4', 'audi', 2011, 260, 2000);
console.log(autoB);
console.log(autoB.drive());
console.log(autoB.info());
console.log(autoB.increaseMaxSpeed(80));
console.log(autoB.changeYear(2017));
console.log(autoB.addDriver('Ivan', 33, 16));
// console.log(autoB.addDriver('Viktor', 30, 5));
